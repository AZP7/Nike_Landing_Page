...
function Product() {
  ...
  return (
    ...
    <section className='flex flex-col'>
        ...
        <div className='flex flex-wrap lg:items-center lg:h-[100vh] justify-start lg:justify-evenly'>
            {shoesData.map((item,index)=>(
                <div key={index} className='flex md:ps-[7%] lg:p-0 lg:w-[20%] md:w-[28%] flex-col ps-8'>
        ...
        <div className='flex flex-col w-full justify-center  lg:items-start lg:h-[100vh] items-center lg:flex-row'>
            <div className='ps-8 mb-5 lg:ps-[5%] md:ps-[7%] lg:w-[55%] lg:h-full lg:mb-0 '>
            ...
            <img src={shoe8} alt="Big Shoes" className='w-[85%] lg:w-[45%] lg:pe-[3%] md:w-[60%] object-contain' />
        </div>
