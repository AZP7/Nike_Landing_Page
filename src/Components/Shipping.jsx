...
function Shipping() {
  ...
  return (
    <section className='flex flex-col justify-center items-center pb-4'>
      ...
      <div className='flex flex-col lg:flex-row lg:justify-around lg:h-[50vh] mt-4 md:w-full justify-center items-center'>
        {shipping.map((item,index)=>(
          <div key={index} className='border border-gray-100 shadow-lg h-[30vh] lg:h-full p-8 flex flex-col justify-center items-start rounded-xl w-[75%] lg:w-[30%] md:w-[80%] mb-2 mt-2 '>
      ...
      <div className='lg:w-[100vw] lg:h-[100vh] '>
        ...
        <div className='mt-4 md:mt-[9%]  flex'>

          <img src={offer} className='hidden lg:block w-[50%] object-contain md:ps-[3%] md:mb-[7%]' alt="Offer Photo" />
        <div>
